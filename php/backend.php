...
if (isset($_REQUEST["id"]) > 0 && isset($_REQUEST["id"]) != '') {
    $id = trim($_REQUEST["id"]);
        ...
        ################################################ INICIO REGISTRAR UN DETENIDO - V 2.0 ##################
        ########################################################################################################
        ########################################################################################################
     
    if ($_REQUEST["tipo"] == "registro_datosf") { // SI EL TIPO VIENE DEL FORMULARIO DE REGISTRO DATOS DEL DETENIDO
