<?php
    ...
    $sql = "SELECT *
    FROM  delitos
    ORDER BY delitos.delito_id DESC LIMIT $start_from, $record_per_page";
        ...
        if(mysqli_num_rows($resultado) > 0){
            ...
            foreach ($resultado as $key):
                ...
                $output .=" 
                                ...
                                <td>".$key['codigo']."</td>
                                <td>
                                    <a href='detalle_delito.php?id=".$key['delito_id']."' title='Ver Detalle del Delito' class='btn btn-floating waves-effect waves-light blue'><i class='material-icons'>info</i></a>";
                ...
                if (isset($_SESSION['r_usuario'])) {
                    ...
                    if ($r_usuario === '1') {
                        ...
                        $output .="
                                    <a href='editar_delito.php?id=".$key['delito_id']."' title='Editar Datos del Delito' class='btn btn-floating waves-effect waves-light green'><i class='material-icons'>edit</i></a>
                                    <a href='eliminar_delito.php?id=".$key['delito_id']."' title='Eliminar Registros' class='btn btn-floating waves-effect waves-light red'><i class='material-icons'>delete</i></a>";
                    }
    ...
    $page_query = "SELECT * FROM delitos";  
